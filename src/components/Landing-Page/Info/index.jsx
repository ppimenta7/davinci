  ...
  const [infoAbout, setInfoAbout] = useState()
    ...
    useEffect(() => {
      ...
      document.onmouseover = function (event) {
        ...
        path.classList.contains("cls")
          ? ((span.style.visibility = "hidden"),
            (slide1.style.transform = "translateY(0px)"),
            (slide1.style.height = "120px"),
            (slide1.style.visibility = "hidden"),
            (slide2.style.transform = "translateY(0px)"),(
              (slide2.style.marginBottom = "120px")
            ))
          : null;
        path.classList.contains("cls-2") ? (setInfoTitle(info[0].title), setInfoAbout(info[0].about)) : null;
        path.classList.contains("cls-3") ? (setInfoTitle(info[1].title), setInfoAbout(info[1].about)) : null;
        path.classList.contains("cls-4") ? (setInfoTitle(info[2].title), setInfoAbout(info[2].about)) : null;
        path.classList.contains("cls-5") ? (setInfoTitle(info[3].title), setInfoAbout(info[3].about)) : null;
      ...
      document.onmouseout = function (event) {
        ...
        path.classList.contains("cls")
          ? ((span.style.visibility = "visible"),
            (slide1.style.transform = "translateY(100px)"),
            (slide1.style.height = "250px"),
            (slide1.style.visibility = "visible"),
            (slide2.style.marginBottom = "0"),(
              (slide2.style.transform = "translateY(-150px)")
            ))
          : null;
      };
              ...
              <div className="col-lg-6 valign flex-direction">
                ...
                <div className="container-content">
                  ...
                  >
                      ...
                      <div className="content">
                        <div className="icon">
                          <i className="fa" aria-hidden="true">
                            <span id="span-text" className="fz-18 text-dark">
                              Passe o mouse ou clique sobre os tópicos e veja
                              mais
                            </span>
                          </i>
                        </div>
                    ...
                    <div className="slide slide2 bg-light">
                      <div className="content">
                        <h3>{infoTitle}</h3>
