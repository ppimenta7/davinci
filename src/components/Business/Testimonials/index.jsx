...
const Testimonials = ({ curve }) => {
  ...
  return (
    <section className="testimonials slider-thumbs section-padding pb-60 bg-img parallaxie" data-background={"img/davinci/d4.png"} data-overlay-dark="6">
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12">
            <div className="round-head text-center mb-50">
              <h6 className="ls2 text-u fz-13 fw-600 mb-20 gr-green-text rest">Feedbacks</h6>
